...
def initialize_output(solver, data_dir, Lx,Lz, threeD=False, volumes=False,
    ...
    profiles.add_task("plane_avg(b_mag_tot)", name="b_mag_tot")
    ...
    profiles.add_task("-plane_avg(re_stress_tot)", name="re_stress")
    profiles.add_task("plane_avg(max_stress_tot)", name="max_stress")
    ...
    scalar.add_task("vol_avg(0.5*b_mag**2)", name="ME")
    scalar.add_task("vol_avg(0.5*b_mag_tot**2)", name="ME_tot")
    ...
    slices.add_task("Bx")
    slices.add_task("Bz")
    slices.add_task("b_mag")
    slices.add_task("b_mag_tot")
