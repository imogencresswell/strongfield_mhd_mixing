...
analysis_tasks = initialize_output(solver, data_dir, aspect, plot_boundaries=False, threeD=threeD, mode=mode, slice_output_dt=0.25, output_dt=0.1, out_iter=100) #need to change this when i make output file
